...
describe("Zergchat release request validation", () => {
  ...
  it("accepts numeric stable versions and rejects prerelease stable versions", () => {
    const stable = makeRequest({
      channel: "stable",
      version: "12.34.56",
      release_tag: "zergchat-v12.34.56",
      source_ref: "refs/tags/zergchat-v12.34.56",
    });
    assert.equal(
      validateReleaseRequest(stable, { requestFilename: "zergchat-v12.34.56.json" }).channel,
      "stable",
    );
    ...
    assert.throws(
      () => validateReleaseRequest({
        ...
        release_tag: "zergchat-v12.34.56-rc.1",
        source_ref: "refs/tags/zergchat-v12.34.56-rc.1",
      }, { requestFilename: "zergchat-v12.34.56-rc.1.json" }),
    ...
    assert.throws(
      () => validateReleaseRequest({
        ...
        release_tag: "zergchat-v12.34.56+rebuilt",
        source_ref: "refs/tags/zergchat-v12.34.56+rebuilt",
      }),
